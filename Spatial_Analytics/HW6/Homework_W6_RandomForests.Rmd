...
train <- st_read("C:/Users/alexp/Documents/School/Spatial_analytics/HW/HW3/cds-spatial/data/kaz_training_aggr.shp")

## YOUR CODE

#url <- "https://sciencedata.dk/public/104dc1b7a08529650379d858979ae104/KazEastfused.tif"
#download.file(url, "C:/Users/alexp/Documents/School/Spatial_analytics/HW/HW3/cds-spatial/Week06/KazEastfused.tif")

Kaz <- brick("C:/Users/alexp/Documents/School/Spatial_analytics/HW/HW3/cds-spatial/Week06/KazEastfused.tif")

#shapefile of GPS points taken on top of each mound in Kazanlak
KAZ_mounds <- st_read("C:/Users/alexp/Documents/School/Spatial_analytics/HW/HW3/cds-spatial/data/Kaz_mounds.shp")

#table of mound attributes, including Condition (1-5), Robbed (0/1), Height(numeric), and Landuse(factor)
KAZ_mdata.csv <- read_csv("C:/Users/alexp/Documents/School/Spatial_analytics/HW/HW3/cds-spatial/data/KAZ_mdata.csv")

#there isnt file with this name???
#KAZ_surveyarea <- st_read("C:/Users/alexp/Documents/School/Spatial_analytics/HW/HW3/cds-spatial/data/________")

#polygon shapefiles for individual survey units
KAZ_units <- st_read("C:/Users/alexp/Documents/School/Spatial_analytics/HW/HW3/cds-spatial/data/Kaz_units.shp")
